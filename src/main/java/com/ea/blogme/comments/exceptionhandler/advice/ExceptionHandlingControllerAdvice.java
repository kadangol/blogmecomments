package com.ea.blogme.comments.exceptionhandler.advice;


import com.ea.blogme.comments.exceptionhandler.dto.ApiError;
...
public class ExceptionHandlingControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomeException(final Exception ex) {
        logger.error(ex.getClass().getName());
        logger.error(ex.getMessage());
